...
export default function FxNav() {
  ...
  return (
    <motion.nav
      ...
      <div>
        <p className='text-3xl text-white customfont2'>Ched<span className='text-[#ecae10]'>Fx</span></p>
      </div>

      <div className="md:hidden">
        <button onClick={toggleMenu} className="text-black text-3xl focus:outline-none relative z-40">
          {isOpen
            ? <span className="inline-block text-3xl text-white">&#x2715;</span>
            : <span className="inline-block text-3xl text-white">&#9776;</span>}
        </button>
      </div>
      ...
      <motion.div
        ...
        <div className="w-full md:w-auto flex flex-col z-30 md:flex-row items-center md:items-center md:space-x-4">
          <a href="#Card2" className="hvr-underline-from-center text-lg mb-8 md:mb-0 hover:text-gray-300 transition-transform duration-300" onClick={toggleMenu}>
            Price
          </a>
          <a href="#faq" className="hvr-underline-from-center text-lg mb-8 md:mb-0 hover:text-gray-300 transition-transform duration-300" onClick={toggleMenu}>
            FAQs
          </a>
          <a href="#contact" className="hvr-underline-from-center text-lg mb-8 md:mb-0 hover:text-gray-300 transition-transform duration-300" onClick={toggleMenu}>
            Contact
          </a>
