...
const NoteApp = () => {
  ...
  return (
    <div className='container mx-auto p-4 bg-gray-900 rounded-2xl md:w-[80%] w-full '>
      <h1 className='md:text-4xl lg:text-5xl text-3xl font-bold text-teal-900 text-center mb-8'>
        Daily Trading Notes
      </h1>
